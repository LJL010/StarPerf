...
class routing_policy_plugin_manager:
    def __init__(self):
        ...
        plugins_path = "/Users/bytedance/Desktop/StarPerf_Simulator/StarPerf_Simulator/src/TLE_constellation/constellation_routing/routing_policy_plugin"  # the path where the plug-in is stored
