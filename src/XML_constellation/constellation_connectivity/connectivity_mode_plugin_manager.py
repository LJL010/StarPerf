...
class connectivity_mode_plugin_manager:
    def __init__(self):
        ...
        # collection.
        #package_name = "Users.bytedance.Desktop.StarPerf_Simulator.StarPerf_Simulator.src.XML_constellation.constellation_connectivity.connectivity_plugin"
        plugins_path = "/Users/bytedance/Desktop/StarPerf_Simulator/StarPerf_Simulator/src/XML_constellation/constellation_connectivity/connectivity_plugin"
        ...
        if not os.path.exists(plugins_path):
            raise FileNotFoundError(f"插件目录不存在: {self.plugins_path}")
